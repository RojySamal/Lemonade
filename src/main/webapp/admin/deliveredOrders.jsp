...
<table id="customers">
       ...
       <%  try{
		...
		ResultSet rs=st.executeQuery("select * from cart inner join product on  cart.product_id=product.id where cart.status='Delivered' and cart.orderDate is not NULL");
		while(rs.next())
		{
