...
try
{
	...
	ps.executeUpdate();
	PreparedStatement ps1 = con.prepareStatement("update cart set address=?, city=?, state=?, country=?, mobileNumber=?, orderDate=SYSDATE, deliveryDate=SYSDATE + 7, paymentMethod=?, transaction=?, status=? where email=? and address is NULL");
